...
def update_classifier_classes
  # Clear the environment cache in puppet server because the update-classes endpoint no longer handles this in the node classifier (PE-11042)
  if ! file_sync_helper.file_sync_services_enabled?
