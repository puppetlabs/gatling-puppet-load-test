...
class PE33PerfMedium extends Simulation {

	val httpProtocol = http
		.baseURL("https://puppetserver-perf-sut54.delivery.puppetlabs.net:8140")
		.connection("close")

	val headers_2 = Map("Accept" -> "pson, b64_zlib_yaml, yaml, dot, raw")
...
val chain_2 = exec(http("request_100")
		...
		.exec(http("request_127")
			.put("/production/report/pgtomcat1.foo.delivery.puppetlabs.net")
			.headers(headers_127)
			.body(RawFileBody("PE33PerfMedium_0127_request.txt")))
