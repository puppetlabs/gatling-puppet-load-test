...
class PE33_ConsolePerfTestWithFeeder extends com.puppetlabs.gatling.runner.SimulationWithScenario {
	...
	val chain_0 =
		exec(http("node")
					.get("/production/node/puppet-master")
	...
	val chain_2 =
		...
		.pause(2)
    		.exec(http("report")
					...
					.headers(headers_110)
          .fileBody("PE33_ConsolePerfTestWithFeeder_request_110.txt")
			)
