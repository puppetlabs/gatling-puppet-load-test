...
class PE371_CloseWaitRepro extends SimulationWithScenario {
	...
	val scn = scenario("PE371_CloseWaitRepro")
		.exec(http("node")
			...
			.resources(http("filemeta pluginfacts")
