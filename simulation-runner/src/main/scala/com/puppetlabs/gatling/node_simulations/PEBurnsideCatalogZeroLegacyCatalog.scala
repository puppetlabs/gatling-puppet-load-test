...
class PEBurnsideCatalogZeroLegacyCatalog extends Simulation {
...
val chain_1 = exec(http("request_98")
		...
		.exec(http("request_111")
			...
			.headers(headers_111)
			.body(RawFileBody("PEBurnsideCatalogZeroLegacyCatalog_0111_request.txt")))
