...
class PEBurnsideRecursiveLargeFilesLegacyCatalog extends Simulation {
	...
	val scn = scenario("PEBurnsideRecursiveLargeFilesLegacyCatalog")
		.exec(http("request_0")
			.get("/puppet/v3/node/perf-bl15.delivery.puppetlabs.net?environment=production&transaction_uuid=9079a10f-a195-4de7-80e6-fe43d0ce335e&fail_on_404=true")
			.headers(headers_0))
		.exec(http("request_1")
