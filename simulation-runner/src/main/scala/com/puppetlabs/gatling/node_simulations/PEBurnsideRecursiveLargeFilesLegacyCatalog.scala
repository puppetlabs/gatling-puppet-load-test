...
class PEBurnsideRecursiveLargeFilesLegacyCatalog extends Simulation {
	...
	val scn = scenario("PEBurnsideRecursiveLargeFilesLegacyCatalog")
		...
		.exec(http("request_36")
			...
			.headers(headers_36)
			.body(RawFileBody("PEBurnsideRecursiveLargeFilesLegacyCatalog_0036_request.txt")))
