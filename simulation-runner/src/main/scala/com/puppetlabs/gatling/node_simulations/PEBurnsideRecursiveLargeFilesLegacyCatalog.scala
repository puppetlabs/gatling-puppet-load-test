...
// val uri1 = "https://perf-bl15.delivery.puppetlabs.net:8140/puppet/v3"
	...
	val scn = scenario("PEBurnsideRecursiveLargeFilesLegacyCatalog")
		.exec(http("node")
			.get("/puppet/v3/node/perf-bl15.delivery.puppetlabs.net?environment=production&transaction_uuid=6499d3b6-0b4d-48c0-a6df-592f1bb7e8b5&fail_on_404=true")
			.headers(headers_0))
		...
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION1.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION10.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION11.pdf?environment=production&"))
		.pause(2)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION12.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION13.pdf?environment=production&"))
		.pause(2)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION14.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION15.pdf?environment=production&"))
		.pause(2)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION16.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION17.pdf?environment=production&"))
		.pause(2)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION18.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION19.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION2.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION20.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION21.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION22.pdf?environment=production&"))
		.pause(2)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION23.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION24.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION25.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION3.pdf?environment=production&"))
		.pause(2)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION4.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION5.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION6.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION7.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION8.pdf?environment=production&"))
		.pause(3)
		.exec(http("file content")
			.get("/puppet/v3/file_content/modules/recursive_with_large_files/dir_with_large_files/ELECTROSECTION9.pdf?environment=production&"))
		.pause(4)
		.exec(http("filemeta")
