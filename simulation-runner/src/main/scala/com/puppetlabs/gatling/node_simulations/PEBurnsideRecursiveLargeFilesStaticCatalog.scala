...
class PEBurnsideRecursiveLargeFilesStaticCatalog extends Simulation {
	...
	val scn = scenario("PEBurnsideRecursiveLargeFilesStaticCatalog")
		.exec(http("request_0")
			.get("/puppet/v3/node/perf-bl16.delivery.puppetlabs.net?environment=production&transaction_uuid=4a446752-7acf-46e8-bc8b-9c3d6e0bada9&fail_on_404=true")
			.headers(headers_0))
		.exec(http("request_1")
