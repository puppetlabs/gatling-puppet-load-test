...
module PerfRunHelper
  ...
  # allow 35% variance when comparing 2019 to 2018.1 LTS; PDB-4635
  MAX_VARIANCE_OVERRIDE_PROCESS_PUPPETDB_AVG_MEM = 0.35 if BEAKER_PE_VER =~ /^2019.*/ && BASELINE_PE_VER =~ /^2018.1.*/
